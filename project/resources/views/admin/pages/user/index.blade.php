...
@section('maincontent')
    ...
    <div class="mb-3">
        <a class="text-danger" href="{{ route('encours') }}">Compte en activation</a>
    </div>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li>
                                    <a class="dropdown-item" href="{{ route ('gestion_users.show', [$use->id]) }}">Detail</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route ('gestion_users.edit', [$use->id]) }}">Editer</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ url ('supprimer_user/' .$use->id) }}" onClick="return confirm('You sure??');">Supprimer</a>
                                </li>
                            </ul>
                        </div>
                    </td>
