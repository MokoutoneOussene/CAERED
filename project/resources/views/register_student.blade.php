    ...
    <div class="row mt-5">
        <div class="col-lg-8 col-md-12 form_inner">
            ...
            <div class="form_content">
                <form class="contact-form" method="post" action="{{ route('add_student') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="roles_id" value="3" placeholder="Role user" hidden />
